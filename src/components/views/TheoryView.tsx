...
// Interactive Binary Search Component
import { InteractiveBinarySearch } from '../theory/InteractiveBinarySearch';
...
export const TheoryView: React.FC<TheoryViewProps> = ({
            ...
            ? [
              {
                ...
                description: `Finished topic in Binary Search`,
                xpEarned: xpEarned,
  ...
  const renderInteractiveDemo = (_lesson: TheoryLesson) => {
    return <InteractiveBinarySearch />;
  };
            ...
            {THEORY_LESSONS.map((chapter, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-3 rounded-2xl transition-all relative flex items-start gap-3 cursor-pointer group ${isActive
                ...
                >
                  {/* Chapter Number */}
                  <div
                    className={`font-mono text-xs font-extrabold shrink-0 mt-0.5 px-2 py-0.5 rounded-md ${isActive
                  ...
                  <div className="flex-1 min-w-0 space-y-0.5">
                    <h2
                      className={`text-xs font-bold truncate leading-tight ${isActive
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/90 dark:border-slate-800 p-6 sm:p-8 shadow-xs space-y-7">
            ...
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              <span className="font-mono text-xs font-extrabold uppercase tracking-widest text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/80 px-3 py-1 rounded-lg border border-blue-100 dark:border-blue-900/60">
                CHAPTER {currentChapter.chapterNumber} // {currentChapter.categoryLabel || 'BINARY SEARCH'}
              </span>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    {currentChapter.criticalSpecifications.map((spec, sIdx) => {
                      ...
                      return (
                        ...
                        >
                          <span className="w-2 h-2 rounded-full bg-amber-500 dark:amber-400 mt-1 shrink-0 ring-2 ring-amber-200 dark:ring-amber-900/60" />
                    ...
                    {(['javascript', 'python', 'java', 'cpp', 'c'] as CodeLanguage[]).map((lang) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-2.5 py-1 rounded-lg text-xs font-mono font-bold transition-all cursor-pointer ${isActiveLang
            ...
            <div className="pt-6 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
              <button
                ...
                className={`w-full sm:w-auto px-5 py-3 rounded-2xl font-bold text-xs sm:text-sm flex items-center justify-center gap-2 transition-all cursor-pointer shadow-xs ${isCurrentCompleted
